# 1 "keyboard.S"
# 1 "/home/viewv/oslab/linux-0.11/kernel/chr_drv//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "keyboard.S"
...
# 键盘缓存队列数据结构tty_queue队列中的偏移量
head = 4
tail = 8
proc_list = 12
buf = 16
# 程序使用了三个标志字节，mode是键盘的特殊键（ctrl或者是alt或者是caps的按下标志
# LED表示键盘灯的位置。e0是收到扫描码0xe0或者0xel的位置
# mode 7 caps按下 ...
mode:	.byte 0		
leds:	.byte 2		
e0:	.byte 0
