 ...
 *  2020 Zhang Xuenan Add a log file
 */
...
void init(void)
{
	int pid, i;
	/*
	* Here viewvos will create file as soon as possible
	* so move some init() code here
	* Now Add new file hear
	*/

	/*
	*--------------------Ok viewvos Hope its will work fine
	*/
